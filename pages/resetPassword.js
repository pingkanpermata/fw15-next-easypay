  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="flex flex-col flex-[40%] px-10 pt-10 lg:pt-16 gap-5  bg-[#f5f5f5]">
        ...
        <div className="leading-relaxed text-[#302b1e] max-w-[430px]">Now you can create a new password for your EasPay account. Type your password twh ice so we can confirm your new passsword.</div>
