...
const Pin = () => {
  ...
  return (
    <>
      <title>Pin | EasyPay</title>
      <div className="flex h-screen">
        <FormLogin />

        <div className="flex flex-col flex-[40%] px-10 gap-5 items-center pt-16 bg-[#f5f5f5]">
          ...
          <form onSubmit={createPin} className="flex flex-col w-[430px] gap-14">
            ...
            <div>
              <button disabled={pin1 && pin2 && pin3 && pin4 && pin5 && pin6 ? false : true} className={`w-full rounded-xl font-bold py-3 text-white ${pin1 && pin2 && pin3 && pin4 && pin5 && pin6 ? "bg-[#d3ba7a] hover:bg-[#d7c28a]" : "bg-[#DADADA]"}`}>
                Confirm
              </button>
            </div>
          </form>
