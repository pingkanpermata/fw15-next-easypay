...
const Information = () => {
  ...
  return (
    <>
    <title>Personal Information | EasyPay</title>
      <Navbar />
      <main className="flex px-20 py-7 bg-[#f5f5f5] h-[580px] gap-5">
        <Sidebar profile={true} />
        <div className="flex-[80%] flex flex-col items-center gap-3 pt-5 p-8 bg-[#dac387] rounded-2xl shadow overflow-y-auto">
          <div className="w-full mb-5">
            <div className="font-bold text-lg mb-5 text-stone-800">Personal Information</div>

            <div className="w-[340px] text-stone-900">We got your personal information from the sign up proccess. If you want to make changes on your information, contact our support.</div>
          </div>

          <div className="flex flex-col w-full gap-5">
            <div className="card w-full bg-[#fdfdfd] shadow">
