...
const Register = () => {
  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="flex flex-col flex-[40%] px-10 gap-5 lg:pt-16 bg-[#f5f5f5]">
        ...
        <form onSubmit={register} className="flex flex-col w-full lg:w-[430px] gap-7">
          <div className={`flex gap-3 items-center border-b-2 ${contentFirstName ? "border-[#857752]" : "border-[#A9A9A9]"}`}>
            <BsPerson className={`text-xl ${contentFirstName ? "text-[#857752]" : null}`} />
          ...
          <div className={`flex gap-3 items-center border-b-2 ${contentLastName ? "border-[#857752]" : "border-[#A9A9A9]"}`}>
            <BsPerson className={`text-xl ${contentLastName ? "text-[#857752]" : null}`} />
          ...
          <div>
            <button type="submit" disabled={contentEmail && contentPassword && contentFirstName && contentLastName ? false : true} className={`w-full rounded-xl py-3 ${contentEmail && contentPassword && contentFirstName && contentLastName ? "bg-[#d3ba7a] hover:bg-[#d7c28a] text-white" : "bg-[#DADADA]"}`}>Sign Up</button>
          </div>
        </form>

        <div className="text-center text-stone-800">
          Already have an account? Let’s{" "}
          <Link href="/login" className="text-[#857752] font-semibold">
            Login
          </Link>
        </div>
      </div>
